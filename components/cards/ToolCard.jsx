...
export default function ToolCard({ tool, refetch }) {
  ...
  return (
    <div
      id="card"
      className={`p-4 shadow-md rounded-md flex flex-col justify-between gap-3 ${theme.theme === "dark" ? "bg-[#37384D]" : "bg-dtheme shadow-odtheme/10"}`}
    >
      <section id="card-head" className="flex items-center gap-3">
      ...
      <section className="leading-[16px]" id="card-center">
        <Link
      ...
      <section className="flex justify-between items-center" id="card-bottom">
        ...
        <div className="flex gap-3 text-odtheme/80">
          ...
          <div className="flex items-center gap-1">
            <Love className="w-[10px] h-[9px] cursor-pointer" onClick={() => handleLoveSubmit()}/>
